...
abstract class AppColors {
  ...
  static Color scaffoldColor = const Color(0xffFBF8F1);
  static Color appBarColor = const Color(0xff181824);
  static Color primaryLight = const Color(0xff31313F);
  static Color subHeaderTextColor = const Color(0xff787878);
  static Color headerTextColor = const Color(0xffC3937C);
}
